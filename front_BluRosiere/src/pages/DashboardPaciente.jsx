...
export const DashboardPaciente = () => {
    ...
    const pastAppointments = appointments.filter(apt => {
        ...
        return (
            ...
            <h1 className="text-3xl font-bold text-white/70">Meu Dashboard</h1>
            ...
            <h2 className="text-xl font-semibold text-white/70">Próximas Sessões</h2>
            </div>
            
                    {upcomingAppointments.length === 0 ? (
            <div className="text-center py-8">
            <p className="text-white/70 mb-4">Você não tem sessões agendadas.</p>
            <Link to="/agendamento">
