 ...
 */
 ...
 const initialRequests = [
   ...
   {
    id: 3,
    patientName: 'Carolina Souza',
    patientEmail: 'carolina.souza@email.com',
    patientPhone: '(11) 97777-3333',
    preferredPsychologist: 2,
    description: 'Gostaria de iniciar terapia para ansiedade. Tenho disponibilidade às terças e quintas pela manhã.',
    urgency: 'alta',
    preferredDates: ['2025-09-25', '2025-09-27'],
    preferredTimes: ['09:00', '10:00'],
    status: 'pendente',
    createdAt: new Date().toISOString()
  } 
